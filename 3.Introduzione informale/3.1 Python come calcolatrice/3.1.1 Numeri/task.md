...
che spiega
come [attivare l'interprete ](https://drive.google.com/file/d/1Xuy6vo1cvDAQemLDIM3RS_6afwmgdxZm/view?usp=drive_link) <span class=yel>(link utenti con mail istituzionale)</span> ed sseguire gli esercizi nella
console, [stampare lo standard output della console python in un file locale ](https://drive.google.com/file/d/1EOvc01A_T4QV4BD3pk8Rk4HIw9KyPXj8/view?usp=drive_link)<span class=yel>(link utenti con mail istituzionale)</span>,
svolgere gli esercizi, verificandone la correttezza.
...
1. <span class=gil>una espressione aritmetica su interi </span> con tutti gli operatori aritmetici in modo che il risultato sia di tipo intero
   <br>es.<br><span class=gre>In[2]:  </span>1+2\*3-4<br><span class=wit>Ou[2]:  </span>3
...
3. Quindi la divisione tra interi <span class=yel>restituisce un float</span> anche se il resto è nullo.
   <br><span class=gre>In[6]:  </span>17 / 5 # Scegli due numeri e <span class=gil>dividili in modo da avere un resto</span><br><span class=wit>Ou[6]:  </span>3.4<br>
   <br><span class=gre>In[7]:  </span> _ + 17 % 5 # <span class=gil>aggiungi </span>il resto 17 % 5 al risultato appena stampato e referenziato da '\_'<br><span class=wit>Ou[7]:  </span>5<br>
...
4. <span class=gil>Assegna </span>due valori interi a due variabili, il secondo come risultato di una espressione aritmetica, poi li
   ...
   <br><span class=gre>In[10]:  </span>base * altezza<br><span class=wit>Ou[10]:  </span>112<br>
...
7. <span class=gil>Assegna </span>8.5% alla variabile iva, 100 alla variabile prezzo e calcola prezzo + iva utilizzando la variabile '_' che in
   ...
   <br><span class=gre>In[14]:  </span>prezzo * iva # tassa<br><span class=wit>Ou[14]:  </span>?<br>
   <br><span class=gre>In[15]:  </span>prezzo + _ # prezzo + tassa<br><span class=wit>Ou[15]:  </span>?<br>

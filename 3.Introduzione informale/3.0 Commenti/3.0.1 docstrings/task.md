...
<span class=gil>**3.0 Commenti**</span>

<span class=cya>**3.0.1 Commenti e docstring**
...
2. <span class=yel> scrivi </span>al prompt dell'interprete IPython <span class=gil>In [numero di riga del comando]</span> <span class=whi>una riga di commento </span><br>
...
<div class=hint>
<p>
Per sapere come <span class="yel">eseguire un task nella console</span> vedere il video eseguendo lo script 
<a href="course://3.Introduzione informale/3.0 Commenti/3.0.1 docstrings/ComeSalvareOutputTaskInPdf.py">ComeSalvareOutputTaskInPdf.py</a> selezionando Run col tasto destro, oppure nelle configurazioni di esecuzione. <span class=yel>Attenzione alle differenze rispetto al video</span>: <br>
    1. <span class=yel>console IPython</span> al posto della standard;<br>
    2. <span class=yel>riportare da</span><span class=gil>'PyDev console: using IPython 9.5.0'</span>, dal tooltip della scritta evidenziata <span class="gry">Pyton Console</span>, visualizzata nella console cliccandola</p>
<p>
Per sapere come <span class=yel>salvare l'output di un task come file .pdf</span> vedere il video eseguendo lo script 
<a href="course://3.Introduzione informale/3.0 Commenti/3.0.1 docstrings/ComeSalvareOutputTaskInPdf.py">ComeSalvareOutputTaskInPdf.py</a>
</p>
